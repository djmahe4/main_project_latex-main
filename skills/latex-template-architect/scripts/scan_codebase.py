...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scan codebase for documentation metadata.")
    parser.add_argument("--source", default="..", help="Directory to scan")
    parser.add_argument("--output", default="../../docs/extracted_meta.json", help="Path to save results")
